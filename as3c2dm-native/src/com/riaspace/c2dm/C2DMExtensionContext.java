...
public class C2DMExtensionContext extends FREContext {
	...
	public Map<String, FREFunction> getFunctions() {
		...
		functionMap.put("getMessage", new C2DMGetMessageFunction());
		functionMap.put("enableAutoNotify", new C2DMEnableAutoNotifyFunction());
		functionMap.put("disableAutoNotify", new C2DMDisableAutoNotifyFunction());
		functionMap.put("showNotification", new C2DMShowNotificationFunction());
		return functionMap;	
	}
	
	public C2DMMessage message = new C2DMMessage();
